...
const Swatch: FC<SwatchProps> = ({ title, darkmode = true, colors = "", colornames = "", descriptions = "", grid }) => {
    ...
    >
      ...
      <div className={styles.panel}>
        <div className={styles.panelContainer}>
          ...
          <Colors names={colorNamesArray} colorStyle={colorStyle} colors={colorsArray} />
        </div>
      </div>
    </div>
  );
